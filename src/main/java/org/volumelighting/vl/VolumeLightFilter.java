...
public class VolumeLightFilter extends Filter {
    ...
    protected void initFilter(AssetManager manager, RenderManager renderManager, ViewPort vp, int w, int h) {
        ...
        shadowVolumeRenderer = new VolumeLightRenderer(manager, this.resolution);
        ...
        volumetricLight_mat.setMatrix4("LightViewProjectionInverseMatrix",
                this.lightCam.getViewProjectionMatrix().invert());
        ...
        volumetricLight_mat.setVector2("LightNearFar",
                new Vector2f(this.lightCam.getFrustumNear(), fvm.farPlaneGridDistance())); // this is nasty, but is silly to calculate every frame
...
//            }
    ...
    // pre calculate the depth linearization factors so they can be passed to the
    // shader since they rarely change
...
class FrustumVolumeMesh extends Mesh {
    ...
    protected float farPlaneGridDistance() {
